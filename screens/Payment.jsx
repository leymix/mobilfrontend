...
const Payment = ({ navigation, route }) => {
  ...
  const onlineHandler = async () => {
    ...
    if(paymentMethod==="ONLINE"){
      Toast.show({
        type: "error",
        text1:"Bu Yöntem Devre Dışıdır ",
        text2:`En kısa sürede açılacaktır.`
      })
    ...
    //end new development
        ...
        //payment system : not working now
  ...
  return loaderLoading ? (
    ...
    <View style={defaultStyle}>
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.radioStyle}>
            <Text style={styles.radioStyleText}>Kapıda Ödeme</Text>
      ...
      >
        ...
        >
          {paymentMethod === "COD" ? "Siparişi Tamamla" : "Ödeme"}
        </Button>
      </TouchableOpacity>
    </View>
  );
